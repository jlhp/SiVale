...
public class NumberPickerPreference extends DialogPreference
{
    ...
    public NumberPickerPreference(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            setDialogIcon(a.getResourceId(R.styleable.NumberPickerDialogPreference_android_dialogIcon, R.mipmap.ic_sync_white_smallest));
            setDialogTitle(a.getString(R.styleable.NumberPickerDialogPreference_android_dialogTitle));
            setNegativeButtonText(a.getString(R.styleable.NumberPickerDialogPreference_android_negativeButtonText));
            setPositiveButtonText(a.getString(R.styleable.NumberPickerDialogPreference_android_positiveButtonText));
        }
        finally
        {
            a.recycle();
